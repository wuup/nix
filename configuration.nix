...

{
  ...
  # Directly within the attribute set
  ...
  # Systemd service to download and setup the AppImage
  systemd.services.cursorAppImage = {
    description = "Download Cursor AppImage for user debug";
